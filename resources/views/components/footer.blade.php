    ...
    <div class="max-w-[1200px] mx-auto">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-4">
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <a href="tel:+8801700000000" class="text-[14px] text-white hover:opacity-70 transition-opacity" style="font-weight: 450;">+880 1700-000000</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            <p class="text-[13px] text-slate-gray" style="font-weight: 450;">
                &copy; ২০২৬ বাংলা ভাষা ও সাহিত্য প্রাক্তন ছাত্র সমিতি। সর্বস্বত্ব সংরক্ষিত।
            </p>
