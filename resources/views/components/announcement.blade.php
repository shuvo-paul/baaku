            ...
            <div class="px-8 py-10 lg:px-16 lg:py-12 flex flex-col lg:flex-row lg:items-center gap-8 lg:gap-16">
                ...
                <div class="flex items-center gap-6 lg:gap-0 lg:flex-col lg:text-center shrink-0 lg:w-[140px]">
                    <div class="relative flex items-center justify-center" aria-hidden="true">
                        <span class="relative w-3 h-3 rounded-full bg-accent pulse-dot"></span>
                    </div>
                    <div class="lg:mt-4">
                        <span class="text-[12px] font-bold uppercase tracking-[0.04em] text-accent block lg:mb-1">আগস্ট</span>
                        <span class="text-[48px] lg:text-[56px] font-medium leading-none tracking-[-0.02em] text-canvas-cream block">১৫</span>
                        <span class="text-[13px] text-dust-taupe block mt-1">২০২৬</span>
                    </div>
                </div>
                ...
                <div class="flex-1">
                    <div class="flex items-center gap-2 mb-4">
                        <span class="uppercase text-[13px] font-bold tracking-[0.04em] text-dust-taupe">ঘোষণা</span>
                    </div>
                    <h2 class="font-display text-[24px] lg:text-[28px] font-medium leading-[1.2] tracking-[-0.02em] text-canvas-cream mb-3">
                        বার্ষিক সাধারণ সভা — সকল সদস্যদের উপস্থিতি কামনা করা হচ্ছে
                    </h2>
                    <p class="text-[15px] text-dust-taupe leading-[1.5] mb-6 max-w-[550px]" style="font-weight: 450;">
                        আগামী ১৫ আগস্ট বিকেল ৪টায় অনুষ্ঠান কক্ষে বার্ষিক সাধারণ সভা অনুষ্ঠিত হবে। সকল আজীবন সদস্যদের উপস্থিত থাকার অনুরোধ জানানো হচ্ছে।
                    </p>
                    <a href="#" class="inline-flex items-center gap-2 text-canvas-cream font-medium text-[16px] tracking-[-0.02em] hover:text-accent transition-colors group">
                        বিস্তারিত জানুন
