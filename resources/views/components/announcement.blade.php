        ...
        <div class="bg-ink rounded-[40px] overflow-hidden">
            <div class="px-8 py-10 lg:px-16 lg:py-12 flex flex-col lg:flex-row lg:items-center gap-8 lg:gap-16">
                ...
                <div class="flex items-center gap-6 lg:gap-0 lg:flex-col lg:text-center shrink-0 lg:w-[140px]">
                    ...
                    <div class="lg:mt-4">
                        <span class="text-[12px] font-bold uppercase tracking-[0.04em] text-signal-orange-light block lg:mb-1">আগস্ট</span>
                ...
                <div class="flex-1">
                    ...
                    <a href="#" class="inline-flex items-center gap-2 text-canvas-cream font-medium text-[16px] tracking-[-0.02em] hover:text-signal-orange-light transition-colors group">
                        বিস্তারিত জানুন
